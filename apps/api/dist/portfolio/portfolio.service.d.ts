...
export declare class PortfolioService {
    ...
    create(userId: string, tenantId: string, dto: CreatePortfolioDto): Promise<Portfolio>;
    findAll(userId: string, tenantId: string): Promise<Portfolio[]>;
    ...
    getSummary(id: string, userId: string, tenantId: string): Promise<{
        netWorth: number;
